/*
 ...
 https://github.com/mjancewicz/jQuery-Tags-Input
...
(function($) {
	...
	$.fn.doAutosize = function(o){
		...
		var testerWidth = testSubject.width(),
			newWidth = (testerWidth + o.comfortZone) >= parseInt(minWidth) ? testerWidth + o.comfortZone : parseInt(minWidth),
			currentWidth = input.width(),
			isValidWidthChange = (newWidth < currentWidth && newWidth >= minWidth)
				|| (newWidth > parseInt(minWidth) && newWidth < parseInt(maxWidth));
		// Animate width
